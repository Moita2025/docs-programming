...
(AI/ML API)[https://aimlapi.com/ai-ml-api-pricing] 提供了四个免费小参数 LLM 模型的调用接口。
...
| Gemma 3 (12B)  | [https://aimlapi.com/models/gemma-3-12b-api](https://aimlapi.com/models/gemma-3-12b-api) |
