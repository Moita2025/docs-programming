...
- 使用依赖：[<code>queue.h</code>](https://moita2025.github.io/docs-programming/2026/05/31/050-cpp-linked-queue-impl/)
- 使用依赖：[<code>sqstack.h</code>](https://moita2025.github.io/docs-programming/2026/05/31/051-cpp-sequential-stack-impl/)
