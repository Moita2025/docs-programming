...
```markdown
- 使用依赖：[<code>模块名称</code>](https://moita2025.github.io/docs-programming/文件名（无后缀）)
```

示例：

```markdown
- 使用依赖：[<code>path_parser_lib.bat</code>](https://moita2025.github.io/docs-programming/026-cmd-file-path-str-parse/#模块型)
```
...
* URL 格式为 `https://moita2025.github.io/docs-programming/` + 目标页面的文件名（去掉 `.md` 后缀）。
...
- 使用依赖：[<code>模块名称</code>](https://moita2025.github.io/docs-programming/文件名)
